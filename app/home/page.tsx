...
export default function HomePage() {
  ...
  return (
    <div className="home-page min-vh-100 bg-light">
      {/* Banner/Hero Section */}
      <section className="hero-section-green py-5 mb-4" style={{background: '#f3f4f6', borderRadius: '0 0 32px 32px'}}>
      ...
      <section className="container mb-5">
        <div className="row g-4 home-below-banners">
          <div className="col-md-6">
            ...
            >
              <span style={{background:'#dc3545',color:'#fff',fontWeight:700,fontSize:22,padding:'8px 28px',borderRadius:12,marginBottom:24,display:'inline-block'}}>Giảm ngay 20%</span>
              <h2 style={{fontWeight:800,fontSize:'2.3rem',color:'#222',marginBottom:24,lineHeight:1.1}}>Rau củ tươi sạch<br/>100% tự nhiên</h2>
              <button style={{background:'#ffc300',color:'#222',fontWeight:700,border:'none',borderRadius:10,padding:'12px 32px',fontSize:20,boxShadow:'0 2px 8px rgba(220,53,69,0.08)'}}>Mua ngay</button>
            </div>
          </div>
          <div className="col-md-6">
            <div
            ...
            >
              ...
              <h2 style={{fontWeight:800,fontSize:'2.3rem',color:'#222',marginBottom:24,lineHeight:1.1}}>Trái cây tươi<br/>Chất lượng tuyệt hảo</h2>
