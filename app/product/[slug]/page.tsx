...
export default function ProductDetailPage() {
  ...
  const [tab, setTab] = useState<"desc" | "profile" | "review" | "related">(
    "desc"
  );
          ...
          <div className="row">
            ...
            <div className="col-md-7 position-relative">
              ...
              <div className="bg-light rounded p-3 mb-3">
                <ul className="mb-2">
                  <li>
                    Mua <span className="text-success fw-bold">02</span> hộp
                    tặng{" "}
                  ...
                  <li>
                    Mua <span className="text-success fw-bold">04</span> hộp
                    tặng{" "}
                    <a href="#" className="text-primary">
                      Đồ chơi lắp ráp
                    </a>
                ...
                <div className="text-secondary mb-2" style={{ fontSize: 14 }}>
                  Khuyến mãi kết thúc lúc:{" "}
                  <span className="fw-bold">9h00 tối, 25/5/2024</span>
                </div>
            ...
            <div className="col-md-5">
              <div className="card shadow-sm p-3" style={{ borderRadius: 12 }}>
                ...
                <div className="mb-2 fw-bold">
                  Đặt hàng nhanh 24/7
                  <br />
                  <span className="fw-normal">(025) 3886 25 16</span>
                </div>
                <div className="mb-2">
                  <i className="bi bi-truck"></i> Giao từ{" "}
