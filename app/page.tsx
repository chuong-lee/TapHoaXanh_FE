    ...
    <>
      ...
      <main className="main-content" style={{ paddingTop: 0 }}>
        <div className="home-page min-vh-100 bg-light">
          {/* Banner/Hero Section */}
          <section
            className="hero-section-green mb-4"
            style={{
              background: "#f3f4f6",
            ...
            <div className="container">
              <div className="row align-items-center">
                <div className="col-lg-7 mb-4 mb-lg-0">
                  <div className="mb-2">
                    <span
                      className="badge bg-danger bg-opacity-10 text-danger px-3 py-2 fw-bold"
                      style={{ fontSize: "1rem" }}
                    >
                      100% Rau củ hữu cơ
                    </span>
                  ...
                  <h1
                    ...
                    style={{ lineHeight: 1.1, fontSize: "2.8rem" }}
                  >
                    Cách tốt nhất để
                    <br />
                    làm đầy ví của bạn.
          ...
          <section className="container mb-5">
            <div
              className="featured-banner-products d-flex align-items-stretch"
              style={{ gap: "12px" }}
            >
              {/* Banner bên trái */}
              <div
                className="featured-banner bg-dark text-white rounded-4 p-4 d-flex flex-column justify-content-between h-100"
              ...
              <div className="featured-product-list d-flex flex-row align-items-stretch">
                {products.slice(0, 4).map((product, idx) => (
                  ...
                  >
                    ...
                    >
                      <i className="fa-solid fa-cart-plus me-2"></i> Xem chi
                      tiết
                    </button>
                  </div>
                ))}
            ...
            {loading ? (
              ...
              <div className="product-list-grid">
                {currentProducts.map((product) => (
                  <div
                    className="custom-product-card d-flex flex-column h-100 position-relative"
                    key={product.id}
                  >
                    {product.discount > 0 && (
                      <span
            ...
            <div className="row g-4 home-below-banners">
              ...
              <div className="col-md-6">
                <div
                  ...
                  style={{
                    background:
                      "#ffd43b url('/client/images/coffe.jpg') no-repeat right bottom / contain",
                    borderRadius: 32,
                    minHeight: 340,
                    position: "relative",
                    overflow: "hidden",
          ...
          <section className="container mb-5">
            ...
            >
              <div className="col-md-7 mb-4 mb-md-0">
                ...
                >
                  Ở nhà & nhận mọi nhu cầu
                  <br />
                  hàng ngày từ cửa hàng của chúng tôi
                </h2>
                <div
                  className="mb-3 text-secondary"
                  style={{ fontSize: "1.1rem" }}
                >
                  Bắt đầu mua sắm cùng{" "}
